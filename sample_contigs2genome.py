...
col_names='pNpS_variants'
out_dir='G:/SYSU_daily/SNP/result_merge/pNpS'
...
for line in gen_stb:
    ...
    if line[1][:-3] not in out_index:
        out_index[line[1][:-3]]=[line[0]]
    else:
        out_index[line[1][:-3]].append(line[0])
